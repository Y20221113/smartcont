...
contract Monkey is Ownable, ERC721Enumerable, ERC721URIStorage {
    ...
    //mapping(uint256 => uint256) public tokenIdToReading;
...
function generateCharacter() public pure returns (string memory) {
    ...
    function mint(string memory name, string memory birth,  uint256 listen, /*uint256 reading,*/ string memory testDate, string memory expirationDate) external {
        _tokenIds.increment();
        ...
        //tokenIdToReading[tokenId] = reading;
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(ERC721URIStorage, ERC721Enumerable) returns (bool) {
